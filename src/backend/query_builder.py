...
class BaseQueryBuilder:
    def __init__(self, query_params: HotelsSearchQueryBasic) -> None:
        ...
        self._schema_attribute_mapping = {
            ...
            "earliestDeparture": Offer.outbound_departure_datetime,
            "latestReturn": Offer.inbound_departure_datetime,
        }
        ...
        self._parameter_filter_mapping = {
            ...
            "earliestDeparture": partial(self._date_comparison_filter, op=operator.ge),
            "latestReturn": partial(self._date_comparison_filter, op=operator.le),
        }
